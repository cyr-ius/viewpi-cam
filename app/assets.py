...
css_custom = Bundle(
    "../ressources/css/custom.css", filters="cssmin", output="css/custom.css"
)
...
js_pipan = Bundle("../ressources/js/pipan.js", filters="rjsmin", output="js/pipan.js")

js_custom = Bundle(
    "../ressources/js/color_modes.js",
