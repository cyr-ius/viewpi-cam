...
RUN apk add --no-cache --virtual build build-base python3-dev cmake make gcc linux-headers ninja git rust cargo openssl
...
RUN /env/bin/pip3 install opencv-python
