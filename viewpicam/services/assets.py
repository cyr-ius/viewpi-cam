...
css_custom = Bundle(
    "../viewpicam/ressources/css/custom.css", filters="cssmin", output="css/custom.css"
)
...
js_pipan = Bundle("../viewpicam/ressources/js/pipan.js", filters="rjsmin", output="js/pipan.js")

js_custom = Bundle(
    "../viewpicam/ressources/js/color_modes.js",
    "../viewpicam/ressources/js/custom.js",
    filters="rjsmin",
    output="js/custom.js",
)
